...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Real-time American Sign Language Recognition with Vision Transformer</p>
            <div class="model-info">
                <span class="model-badge" id="modelBadge">Vision Transformer (ViT)</span>
                <div style="margin-top: 10px; font-size: 0.9em; opacity: 0.8;">
                    Advanced attention-based neural network for sign language recognition
                </div>
            </div>
        </div>
